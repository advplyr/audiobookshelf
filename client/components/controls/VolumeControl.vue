<template>
  <div class="relative" v-click-outside="clickOutside" @mouseover="mouseover" @mouseleave="mouseleave">
    ...
    <transition name="menux">
      <!-- left-1/2 + -ml-3 (half of w-6) centers the popup on the icon regardless of the icon's rendered width.
           Margin rather than -translate-x-1/2 because the menux transition animates transform. -->
      <div v-show="isOpen" class="volumeMenu h-28 absolute bottom-2 left-1/2 -ml-3 w-6 py-2 bg-bg shadow-xs rounded-lg" style="top: -116px">

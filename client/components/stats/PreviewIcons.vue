  ...
  <div class="flex flex-wrap justify-center mt-6">
    <div class="flex p-2">
      ...
      <div class="px-1">
        ...
        <p class="text-xs md:text-sm text-white">{{ $strings.LabelStatsItemsInLibrary }}</p>
      </div>
    </div>
    ...
    <div class="flex p-2">
      ...
      <div class="px-1">
        ...
        <p class="text-xs md:text-sm text-white">{{ useOverallHours ? $strings.LabelStatsOverallHours : $strings.LabelStatsOverallDays }}</p>
      </div>
    </div>
    ...
    <div v-if="isBookLibrary" class="flex p-2">
      ...
      <div class="px-1">
        ...
        <p class="text-xs md:text-sm text-white">{{ $strings.LabelStatsAuthors }}</p>
      </div>
    </div>
    ...
    <div class="flex p-2">
      ...
      <div class="px-1">
        ...
        <p class="text-xs md:text-sm text-white">{{ $strings.LabelSize }} ({{ totalSizeMod }})</p>
      </div>
    </div>
    ...
    <div class="flex p-2">
      ...
      <div class="px-1">
        ...
        <p class="text-xs md:text-sm text-white">{{ $strings.LabelStatsAudioTracks }}</p>
      </div>
    </div>
  </div>
</template>

...
class ApiController {
  ...
  init() {
    ...
    this.router.get('/library/:id/audiobooks', LibraryController.getBooksForLibrary.bind(this))
    this.router.get('/library/:id/search', LibraryController.search.bind(this))

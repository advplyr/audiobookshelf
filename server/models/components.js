 ...
 *           type: string
 *           example:
 *             - /audiobooks/Terry Goodkind/Sword of Truth/Wizards First Rule
 *         relPath:
 *           description: The path, relative to the library folder, of the library item.
 *           type: string
 *           example:
 *             - Terry Goodkind/Sword of Truth/Wizards First Rule
 *         isFile:
 *           description: Whether the library item is a single file in the root of the library folder.
 *           type: boolean
 *           example:
 ...
 *           type: string
 *           example:
 *             - Terry Goodkind - SOT Bk01 - Wizards First Rule 01
 *     podcast:
 *       type: object
 *       properties:
 *         libraryItemId:
 ...
 *           type: string
 *           example:
 *             - Terry Goodkind - SOT Bk01 - Wizards First Rule 01.mp3
 *         contentUrl:
 ...
 *           type: string
 *           example:
 *             - li_bufnnmp4y5o2gbbxfm-ep_lh6ko39pumnrma3dhv
 *         libraryItemId:
 ...
 *           type: string
 *           example:
 *             - /metadata/items/li_bufnnmp4y5o2gbbxfm/cover.jpg
 *         duration:
 ...
 *           type: string
 *           example:
 *             - 69b7e852-23a6-4587-bed3-6a5966062e38
 *           format: uuid
 *         userId:
 *           description: User identifier.
 *           type: string
 *           example:
 *             - 3c479fe6-6bf8-44e4-a4a6-680c768b501c
 *           format: uuid
 *         deviceId:
 ...
 *           type: string
 *           example:
 *             - Triggered when a podcast episode is auto-downloaded
 *         variables:
 ...
 *           type: string
 *           example:
 *             - https://abs.example.com/feed/li_bufnnmp4y5o2gbbxfm
 *           format: url
 *         meta:
 ...
 *           type: string
 *           example:
 *             - https://abs.example.com/feed/li_bufnnmp4y5o2gbbxfm/cover
 *           format: url
 *         feedUrl:
 ...
 *           type: string
 *           example:
 *             - https://abs.example.com/item/li_bufnnmp4y5o2gbbxfm
 *           format: url
 *         explicit:
